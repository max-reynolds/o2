...
#ifdef OSX
#include "Render/OSX/RenderBase.h"
#endif
...
namespace o2
{
	...
	protected:
		...
		bool              mRenderTargetsAvailable = false; // True, if render targets is available
		...
		bool              mReady = false;                  // True, if render system initialized
	...
	protected:
        ...
        // Builds vertex and fragmest shaders
